...
### 空格和换行的非一般操作 ###  
那么有人可能要问了，难道我就没有办法去输出多个空格或者换行吗？当然有。我们前面说过Markdown是一种跟HTML相似的标记语言，所以是可以运用HTML的转义字符的，这里我们就可以运用"`&nbsp;`"和"`</br>`"来达成多个空格和换行的效果:![多个换行](http://r.photo.store.qq.com/psb?/V117MGIn3dBRDw/ql.tZC3nQu9Gmanc3q3fiRNmHppSaIWhbHXHZjq9L9o!/r/dPMAAAAAAAAA)
